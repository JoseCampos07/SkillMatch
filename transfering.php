...
class OutgoingPaymentCreateAmount extends Command
{
    ...
    {
        $WALLET_ADDRESS =  $_ENV['https://ilp.interledger-test.dev/e2c3b72c'];
        $PRIVATE_KEY = $_ENV[<<<EOD
        -----BEGIN PRIVATE KEY-----
        MC4CAQAwBQYDK2VwBCIEINNa7A19IusDBYRxjaiwcchUFbdRZh4YndMcfFV8m9rd
        -----END PRIVATE KEY-----
        EOD];
        $KEY_ID = $_ENV['abf39247-7cbd-4bb7-829e-9c634a03ed8b'];
